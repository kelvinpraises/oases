...
export const dripsStreamingAbi = [
  ...
  },
  {
    ...
    name: 'allPausers',
    outputs: [
      { name: 'pausersList', internalType: 'address[]', type: 'address[]' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    name: 'receiveStreams',
    outputs: [
      { name: 'receivedAmt', internalType: 'uint128', type: 'uint128' },
    ],
    stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    name: 'setStreams',
    outputs: [
      { name: 'realBalanceDelta', internalType: 'int128', type: 'int128' },
    ],
    stateMutability: 'nonpayable',
  },
  {
...
export const marketDriverAbi = [
  {
    ...
    inputs: [
      ...
      {
        name: 'vaultDriver_',
        internalType: 'contract VaultDriver',
        type: 'address',
      },
  ...
  },
  {
    ...
    name: 'VAULT_DRIVER',
    outputs: [
      { name: '', internalType: 'contract VaultDriver', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const vaultAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'sideShares', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'solverConfig_', internalType: 'string', type: 'string' },
      { name: 'creator', internalType: 'address', type: 'address' },
    ],
    name: 'createVault',
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Vault.Board',
        type: 'tuple',
        components: [
          { name: 'pool', internalType: 'uint256', type: 'uint256' },
          { name: 'sideRate', internalType: 'uint256', type: 'uint256' },
  ...
  {
    type: 'function',
    inputs: [{ name: 'marketId_', internalType: 'bytes32', type: 'bytes32' }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'maxEnd', internalType: 'uint32', type: 'uint32' },
          { name: 'depleted', internalType: 'bool', type: 'bool' },
          { name: 'fundStart', internalType: 'uint32', type: 'uint32' },
          { name: 'lostUsdc', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'marketId', internalType: 'bytes32', type: 'bytes32' },
      { name: 'question', internalType: 'string', type: 'string' },
      { name: 'solverConfig', internalType: 'string', type: 'string' },
      { name: 'creator', internalType: 'address', type: 'address' },
