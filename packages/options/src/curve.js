 ...
 */
export function calculateSharesForDeposit(currentSupply, depositAmount, basePriceWad = WAD / 100n // 0.01 WAD initial price
) {
    if (depositAmount === 0n)
        return 0n;
    ...
    if (priceBefore <= 0n)
        return (depositAmount * WAD) / basePriceWad;
